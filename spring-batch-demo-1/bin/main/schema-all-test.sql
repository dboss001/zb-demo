...
DROP TABLE IF EXISTS output_group;
DROP TABLE IF EXISTS output_item;
DROP TABLE IF EXISTS output_total;

DROP SEQUENCE IF EXISTS input_source_seq;
DROP SEQUENCE IF EXISTS output_document_seq;
DROP SEQUENCE IF EXISTS output_group_seq;
DROP SEQUENCE IF EXISTS output_item_seq;
DROP SEQUENCE IF EXISTS output_total_seq;
